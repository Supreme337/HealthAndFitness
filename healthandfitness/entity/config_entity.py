...
from healthandfitness.constant import training_pipeline
...
class DataTransformationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.imputer_object_file_path:str=os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR,"imputer.pkl")
        self.categorical_columns_file_path:str=os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR,"categorical_columns.pkl")