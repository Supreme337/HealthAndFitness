...
from healthandfitness.entity.config_entity import DataIngestionConfig,DataValidationConfig,DataTransformationConfig
from healthandfitness.entity.config_entity import TrainingPipelineConfig
